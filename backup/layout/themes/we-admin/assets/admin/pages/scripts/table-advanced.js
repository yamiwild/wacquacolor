var TableAdvanced = function () {
    ...
    var initTableClient = function () {
        ...
        var oTable = table.dataTable({
            ...
            "tableTools": {
                "sSwfPath": theme_base_url() + "assets/global/plugins/datatables/extensions/TableTools/swf/copy_csv_xls_pdf.swf",
                "aButtons": [{
                    "sExtends": "pdf",
                    "sButtonText": "PDF"
                }, {
        ...
        var tableWrapper = $('#client_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
